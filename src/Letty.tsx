...
export default function Letty() {
  ...
  return (
    <div style={{ fontFamily: "'Inter','Segoe UI',system-ui,sans-serif", background: "linear-gradient(145deg,#ecfdf5 0%,#f8fafc 55%,#f0fdf9 100%)", minHeight: "100vh" }}>
      <style>{`
        ...
        *{box-sizing:border-box}
        ...
        @media(max-width:600px){
          .page-wrap-l{padding:8px 12px!important}
        ...
        @media(min-width:1800px){
          .page-wrap-l,.footer-inner-l{zoom:1.18}
        }
        @media(min-width:2200px){
          .page-wrap-l,.footer-inner-l{zoom:1.4}
        }
        @media(min-width:2800px){
          .page-wrap-l,.footer-inner-l{zoom:1.7}
        }
      `}</style>
      ...
      <div className="page-wrap-l" style={{ width: "100%", padding: "16px 40px" }}>
      ...
      <footer style={{ background: "linear-gradient(135deg,#0f172a,#064e3b)", color: "white", marginTop: 40, padding: "28px 20px 20px" }}>
        <div className="footer-inner-l" style={{ width: "100%", padding: "0 40px" }}>
